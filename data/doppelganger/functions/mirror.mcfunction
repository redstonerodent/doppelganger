...
execute store result entity @e[tag=doppel.moving, limit=1] Pos[0] double -.0001 run data get entity @s Pos[0] 10000
execute store result entity @e[tag=doppel.moving, limit=1] Pos[2] double -.0001 run data get entity @s Pos[2] 10000
